...
async function main () {
  let path;
  if(browser == 'Firefox'){ path = './FirefoxSuccessful.txt';}
  else if(browser == 'Ghostery') {path = './GhosterySuccessful.txt';}
  else if (browser == 'Brave') {path = './BraveSuccessful.txt'; }
  else if (browser == 'Google Chrome') {path = './Google ChromeSuccessful.txt';}
