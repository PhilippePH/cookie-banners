...
async function getTimedOutUrls (browser) {
  ...
  let path
  if (browser === 'Firefox') {
    path = 'webCrawler/websiteSelection/timeouts/FirefoxTimeout.txt'
  } else if (browser === 'Ghostery') {
    path = 'webCrawler/websiteSelection/timeouts/GhosteryTimeout.txt'
  } else if (browser === 'Brave') {
    path = 'webCrawler/websiteSelection/timeouts/BraveTimeout.txt'
  } else if (browser === 'Google Chrome') {
    path = 'webCrawler/websiteSelection/timeouts/Google ChromeTimeout.txt'
  }
